...
class Admin_Notification {
	...
	protected $title = 'Sidetrack Admin Notification';
	...
	public function enqueue_style() {
		if ( ! wp_style_is( 'admin-notification', 'enqueued' ) ) {
			wp_enqueue_style(
				'admin-notification',
				plugins_url( 'inc/css/admin-notification.css', dirname( __FILE__ ) )
			);
		}
	}
}
...
class Admin_Notification_Builder {
	...
	public function get_notification_html() {
		?>
		<div id='message' class='notice <?php esc_html_e( $this->notification_type ); ?> is-dismissible'>
			<p>
				<span class='dashicons <?php esc_html_e( $this->dashicons_class ); ?> sidetrack-notification-icon'></span>
