...
( function() {
	 ...
	 */
	registerBlockType( 'pmb/tweet-04', { // Block name. Block names must be string that contains a namespace prefix. Example: my-plugin/my-custom-block.
		title: __( 'PMB Tweet', 'PMB' ), // Block title.
