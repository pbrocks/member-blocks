...
( function() {
	 ...
	 */
	registerBlockType( 'pmb/basic-block-2', { // Block name. Block names must be string that contains a namespace prefix. Example: my-plugin/my-custom-block.
		title: __( 'PMB Basic', 'PMB' ), // Block title.
